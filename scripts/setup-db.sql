...
-- ==========================================
-- 7. Storage Bucket Details
-- ==========================================
-- Creates the 'products' bucket natively if it doesn't exist
INSERT INTO storage.buckets (id, name, public) 
VALUES ('products', 'products', true) 
ON CONFLICT (id) DO NOTHING;

-- Allows anyone to read images from the products bucket
CREATE POLICY "Public Access" 
ON storage.objects FOR SELECT 
USING ( bucket_id = 'products' );

-- Allows only logged in authenticated users (admins when uploading products) to insert images
