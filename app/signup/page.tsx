        ...
        <div className="bg-white border-3 border-[#1e0f00] rounded-3xl p-8 shadow-[6px_6px_0_#1e0f00]" style={{borderWidth:3}}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" placeholder="Priya Sharma" required className="w-full px-4 py-3 rounded-xl border-2 border-[#995424]/20 bg-[#FFF9ED] text-sm font-semibold focus:outline-none focus:border-[#F47B40]" />
            </div>
            <div>
              <label className="text-xs font-bold text-[#995424] uppercase tracking-wider mb-1 block">Email</label>
              <input type="email" placeholder="priya@example.com" required className="w-full px-4 py-3 rounded-xl border-2 border-[#995424]/20 bg-[#FFF9ED] text-sm font-semibold focus:outline-none focus:border-[#F47B40]" />
            </div>
            <div>
              <label className="text-xs font-bold text-[#995424] uppercase tracking-wider mb-1 block">Phone Number</label>
              <input type="tel" placeholder="+91 98765 43210" required className="w-full px-4 py-3 rounded-xl border-2 border-[#995424]/20 bg-[#FFF9ED] text-sm font-semibold focus:outline-none focus:border-[#F47B40]" />
            </div>
            <div>
